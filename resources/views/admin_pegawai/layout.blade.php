            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="{{ route('disposisi.create') }}" class="sidebar-link"><span
                                            class="hide-menu"> <b>TAMBAH SURAT </br> DISPOSISI</b>
                                        </span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="{{ route('disposisi.index') }}" class="sidebar-link"><span
                                            class="hide-menu"> <b>LIHAT SURAT </br>DISPOSISI</b>
                                        </span></a>
                                </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('pegawais.show',Auth::guard('pgw')->user()->id_pegawai )}}"
